...
export default function CategoryPage() {
  ...
  const { data: products, isLoading: productsLoading, error: productsError } = useProducts(slug)
        ...
        >
          ...
          <Link href="/">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-block px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:shadow-2xl transition-shadow font-semibold"
            >
              View All Products
            </motion.div>
          </Link>
